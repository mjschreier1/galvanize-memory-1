        ...
        it("reads a New Year's resolution", done => {
            request(app)
                ...
                .then(response => {
                    ...
                    assert.include(response.body.resolution.due_date, "1997-05-01");
        ...
        it("creates New Year's resolutions", done => {
            request(app)
                ...
                .then(response => {
                    ...
                    assert.include(response.body.resolution.due_date, "1997-03-01");
        ...
        it("updates a New Year's resolution", done => {
            request(app)
                ...
                .then(response => {
                    ...
                    assert.equal(response.body.resolution.id, 2);
                    assert.include(response.body.resolution.due_date, "1997-07-01");
                    assert.equal(response.body.resolution.resolution, "Do stand-up");
                    return;
                }).then(done).catch(done);
        });
